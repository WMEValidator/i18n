...
"171.enabled": true,
"171.params": {
    "regexp": "/(^| )(?!(adm|abp|al|bp|bł|błj|dr|gen|bryg|pil|dyw|hetm|hm|hr|im|inf|inż|kan|kard|ks|kmdr|kadm|kpt|mjr|marsz|o|os|pil|pl|plut|ppor|ppłk|prał|prym|por|pn|pd|prof|płk|r|rtm|św|śwj|śś|wsch|zach)\\. |r\\.)[^ ]+\\./"
},
