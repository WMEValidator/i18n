...
"props.skipped.problem": "The segment is modified after 2014-05-01 AND locked for you, so " + WV_SHORTNAME + " did not check it",

"err.regexp": "Error parsing option for check #${n}:",

"props.disabled": WV_NAME + ' is disabled',
...
"report.thanks": 'Thank you for using ' + WV_NAME + '!',
...
"msg.zoomout.text": "Zoom out to start " + WV_NAME,
...
"msg.autopaused.tip": WV_NAME + " automatically paused on map drag or window size change",
...
"msg.noissues.tip": "Try to uncheck some filter options or start " + WV_NAME + " over another map area!",
...
"msg.continuing.tip": WV_NAME + " will continue from the location it was paused",
...
"noaccess.text": "<b>Sorry,</b><br>You cannot use " + WV_NAME + " over here.<br>Please check <a target='_blank' href='" + PFX_FORUM + FORUM_HOME + "'>the forum thread</a><br>for more information.",
...
"button.list.tip": "Show a list of checks available in " + WV_NAME,
